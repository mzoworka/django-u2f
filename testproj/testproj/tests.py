...
class TwoFactorTest(TestCase):
    ...
    def login(self):
        return self.client.post(self.login_url, {"username": "test", "password": "asdfasdf", "next": "/next/"})
    ...
    def set_challenge(self):
        ...
        session["u2f_sign_request"] = {
            "publicKey": {
                ...
                "timeout": 60000,
                "rpId": "localhost",
                "extensions": {"appid": "https://localhost:8000"},
            }
        }
...
class TestU2F(U2FTest):
    ...
    def test_add_key(self):
        ...
        self.assertEqual(
            added_key_obj.public_key,
            "pQECAyYgASFYIHlYYfK3OwMqc-wvfVShLshA17BpbFvqSzVafTYshcF7IlggAkUNp9r5xt8Mp9tLpYNxp1Slt7HmKWJBSQouMaqpAbY",
        )
        self.assertEqual(
            added_key_obj.key_handle,
            "0A8u1AifaDA-D6tjOppWWSEUaBScNnDeashgT869algXVHf6-7ZGfVy8asVWgbjiYm5cd7i9WlrWffgMQXTOQg",
        )
...
class TestBackupCode(TwoFactorTest):
    ...
    def test_login_while_already_logged_in(self):
        ...
        r = self.client.post(self.login_url, {"username": "test2", "password": "asdfasdf", "next": "/next/"})
